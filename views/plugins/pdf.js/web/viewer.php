          ...
          <div id="toolbarContainer">
            <div id="toolbarViewer">
              <div id="toolbarViewerLeft">
                ...
                <button id="viewFind" style="display: none;" class="toolbarButton" title="Find in Document" tabindex="12" data-l10n-id="findbar">
              ...
              <?php 
                if ($_SESSION["presentation"]==true) {
                   echo '<button id="presentationMode" class="toolbarButton presentationMode hiddenLargeView" title="Switch to Presentation Mode" tabindex="31" data-l10n-id="presentation_mode">
                          <span data-l10n-id="presentation_mode_label">Presentation Mode</span>
                        </button>';
                }
              ?>

                <span id="presentationMode"></span>
                ...
                <?php 
                   if ($_SESSION["print"]==true) {
                     echo '<button  id="print" class="toolbarButton print hiddenMediumView" title="Print" tabindex="33" data-l10n-id="print">
                      <span data-l10n-id="print_label">Print</span>
                    </button>';
                    }
                ?>
              ...
              <?php 
                if ($_SESSION["download"]==true) {
                 echo '<button id="download" class="toolbarButton download hiddenMediumView" title="Download" tabindex="34" data-l10n-id="download">
                        <span data-l10n-id="download_label">Download</span>
                      </button>';
                }
               ?>
